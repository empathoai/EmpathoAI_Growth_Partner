...
- **Node Version**: The project requires **Node.js >= 20.0.0**.
...
The following scripts are optimized for the Hostinger build-and-run lifecycle:
...
- [ ] **SEO**: Verify `https://empathoai.com/sitemap.xml` is accessible.
