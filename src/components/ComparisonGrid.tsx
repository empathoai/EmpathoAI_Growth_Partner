    ...
    <section className="py-20 md:py-32 px-6 md:px-24 border-b border-white/15 bg-void">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="mb-20 md:mb-32">
          ...
          >
            Institutional <span className="text-noise font-mono">[</span>Rigor<span className="text-noise font-mono">]</span> vs. Market Noise.
          </motion.p>
        </div>
          ...
          >
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <span className="font-mono text-[9px] text-white/30 border border-white/10 px-2 py-1 tracking-[0.3em] uppercase">
              ...
              <ul className="space-y-6">
                {noiseItems.map((item, idx) => (
                  <li key={idx} className="flex items-start gap-5">
                    <X className="w-5 h-5 mt-1 shrink-0 text-white/10" strokeWidth={1} />
                    <span className="font-montserrat font-light text-lg md:text-xl text-white/20 leading-relaxed text-balance">
                      {item}
                    </span>
                  </li>
                ))}
